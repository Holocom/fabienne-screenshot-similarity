...
const BookDetailPage = () => {
  ...
  useEffect(() => {
    // Réinitialiser hasUpdatedRef si l'ID du livre change
  ...
  }, [book, bookDetails, pressLinks, awards, editions, isLoadingBook, isLoadingDetails, isBookError, bookId, updateBookMutation]);

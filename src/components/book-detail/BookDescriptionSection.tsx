...
export const BookDescriptionSection: React.FC<BookDescriptionProps> = ({
  ...
  if (isPetitesHistoiresMusiques && description) {
    ...
    const petitesHistoiresDescription = `Cet ouvrage propose en trente portraits un tour d'horizon de l'histoire des musiques réunionnaises, de la romance au séga en passant par la fusion et le maloya classé au patrimoine mondial par l'Unesco. Chaque portrait est agrémenté de "petites histoires" : anecdote, texte de chanson, événement marquant, fait historique, présentation d'instruments… L'ouvrage comporte également un CD réalisé par le Pôle Régional des Musiques Actuelles.

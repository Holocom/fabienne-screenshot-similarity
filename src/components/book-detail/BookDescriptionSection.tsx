...
interface BookDescriptionSectionProps {
  description: string;
  bookTitle?: string;
  isViveLeChangementAir?: boolean; // Paramètre pour VIVE LE CHANGEMENT D'AIR
}
...
export const BookDescriptionSection: React.FC<BookDescriptionSectionProps> = ({ 
  ...
  if (isViveLeChangementAir) {
    // Formater le texte avec les sauts de ligne explicites en HTML
    const formattedDescription = `
      De 1998 à 2023, l'agenda d'histoire de La Réunion a connu des tirages records. Chaque année, 
      pendant plus de 25 ans, son éditeur a invité des auteurs locaux à travailler sur un thème.<br/>
      L'édition 2010 était consacrée aux pratiques du changement d'air qui se sont développées à partir du XIXe 
    ...
    return (
      <div className="my-6">
        ...
        <div 
          className="text-[#403E43] text-lg leading-relaxed mt-2" 

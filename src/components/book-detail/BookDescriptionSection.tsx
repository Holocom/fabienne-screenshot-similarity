...
export const BookDescriptionSection: React.FC<BookDescriptionSectionProps> = ({ 
  ...
  if (isViveLeChangementAir) {
    // Description avec saut de ligne explicite après "Cilaos"
    return (
      <div className="my-6">
        <h3 className="text-xl font-bold mb-2 text-[#1A1F2C] uppercase">DESCRIPTION</h3>
        <div className="text-[#403E43] text-lg leading-relaxed mt-2">
          <p>
            ...
            siècle dans l'île. D'Hell Bourg à Cilaos
          </p>
          <p>
            en passant par l'Étang-Salé ou St-Gilles-les-Bains, ce tourisme 
